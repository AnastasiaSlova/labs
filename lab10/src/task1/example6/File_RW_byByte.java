...
public class File_RW_byByte {
    public static void main(String[] args) throws IOException {
        ...
        try {
            in = new FileReader("lab10\\src\\task1\\example6\\Новый текстовый документ.txt"); // файл для чтения
            out = new FileWriter("lab10\\src\\task1\\example6\\Новый текстовый документ2.txt", true); // файл для записи
